...
| Enumerações (`enum`) | Conjunto fixo de valores (`pessoa_fisica`/`pessoa_juridica`) usado como tipo de atributo, com construtor associando um código e enum aninhado dentro de outra classe | [TipoCliente.java](Aula09/Enumeracao/dominio/TipoCliente.java) |
